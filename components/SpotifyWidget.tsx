    ...
    <motion.div
      ...
      <AnimatePresence mode='wait'>
        {!expanded ? (
          <motion.div
            key='pill'
            onClick={() => isPlaying && setExpanded(true)}
            ...
            style={{
              ...
              border: `1px solid ${isPlaying ? 'rgba(0,212,255,0.25)' : 'var(--color-border)'}`,
              borderRadius: '100px',
              backdropFilter: 'blur(20px)',
              boxShadow: isPlaying ? '0 8px 32px rgba(0,212,255,0.1)' : 'none',
            ...
            <svg
              ...
              height='14'
              viewBox='0 0 24 24'
              fill={isPlaying ? '#1DB954' : 'var(--color-ghost)'}>
